<div id="newsletter_footer" class="col-sm-6">
    ...
    <form class="fl" action="{{@$mailing->action}}" method="post" target="_blank" novalidate>
        <input class="input-newsletter" type="text" value="" {{ @$mailing->action==''?'disabled="disabled"':'' }} placeholder="Email Address" name="EMAIL" class="input-medium required email" id="newsletter mce-EMAIL"/>
